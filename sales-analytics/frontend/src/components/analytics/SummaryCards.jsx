...
export const SummaryCards = ({ analytics }) => {
  const averageTicketPrice = (analytics.totalRevenue / analytics.ticketsSold || 0).toFixed(2);
  const lastHourSales = analytics.revenueByHour[23]?.saleCount || 0;
  ...
  return (
    <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4 mb-6">
      ...
      <Card>
        ...
        <CardContent>
          <div className="text-2xl font-bold">{lastHourSales}</div>
        </CardContent>
      </Card>
    </div>
  );
